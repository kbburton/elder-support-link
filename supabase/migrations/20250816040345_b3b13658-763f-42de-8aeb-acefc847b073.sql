-- Fix RLS policies for care_groups table to allow creation of new groups
-- Drop all existing policies first
DROP POLICY IF EXISTS "Members can manage their care groups" ON public.care_groups;
DROP POLICY IF EXISTS "Members can view their care groups" ON public.care_groups;

-- Create new separate policies for different operations
