...
-- We need to recreate it with proper ownership
...
-- Create RLS policy that matches the care_groups table security
CREATE POLICY "Members can view group header data" ON public.v_group_header
FOR SELECT 
